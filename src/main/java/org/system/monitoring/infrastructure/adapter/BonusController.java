...
import org.system.monitoring.domain.collection.dto.response.BonusResponseDTO;
...
public class BonusController {
    private final Class<BonusResponseDTO> className = BonusResponseDTO.class;

    @Autowired
    private DocumentService documentService;

    @PostMapping("/create")
    public ResponseEntity<ResponseStatusDTO> create(@Valid @RequestBody BonusRequestDTO obj,
